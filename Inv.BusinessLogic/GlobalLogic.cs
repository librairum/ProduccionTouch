...
namespace Inv.BusinessLogic
{
    public class GlobalLogic
    {
        ...
        public List<Moneda> Spu_Glo_Trae_glo01tablas_Det(string @glo01codigotabla, string @cCampo, string @cFiltro)
        {
        ...
        //public List<TablaGlobal> TraeAyudaGlobalTouch(string @CodigoEmpresa, string @FlagTipoAyuda, string @ParametroFiltroAyuda)
        //{ 
        //    return Accessor.Spu_Glo_Trae_AyudaTouch(@CodigoEmpresa, @FlagTipoAyuda, @ParametroFiltroAyuda);
        //}
        #region Accessor
