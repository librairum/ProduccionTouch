    ...
    public class SedeLogic
    {
                ...
                out string @cMsgRetorno)
        {
            Accessor.Glo_InsertarSede(sede.come05empresa, sede.come05clientetipana, sede.come05clientecod, sede.come05sedeclientescod,
                sede.come05sedeclientesdesc, sede.come05sedeclientesdireccion, sede.come05sedeclientesreferencia, out @cMsgRetorno);

        }

        public void Glo_ActualizarSede(Sede sede, out string @cMsgRetorno)
        {
