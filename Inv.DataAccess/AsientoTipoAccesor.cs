...
namespace Inv.DataAccess
{
    public abstract class AsientoTipoAccesor : AccessorBase<AsientoTipoAccesor>
    {
        ...
        string @FAC09CTA, string @FAC09FLAG, string @FAC09CAMPO, double @FAC09PORCENTAJE, out int @flag, out string @msgretorno);
        ...
        double @FAC09PORCENTAJE,out int @flag, out string @msgretorno);
        ...
        public abstract void Spu_Fact_Ins_VoucherContable(string @ccc01emp, string @ccc01ano, string @ccc01mes, string @FA01usu, 
