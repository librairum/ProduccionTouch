...
namespace Inv.DataAccess
{
    public abstract class CuentaCorrienteAccesor: AccessorBase<CuentaCorrienteAccesor>
    {
        ...
        string @ccm02FEPaisCod, string @CCM02TIPOCLIENTECOD, out int @flag, out string @cMsgRetorno);
        ...
        public abstract void Spu_Glo_Ins_CuentaCorriente(string @ccm02emp, string @ccm02tipana, string @ccm02cod, string @ccm02nom ,
            ...
            string @ccm02Brevete, out string @cMsgRetorno);
        ...
        string @ccm02EstadoContribuyente,string @ccm02SituacionDomicilio,string @ccm02Brevete,
        ...
        public abstract void Sp_Fac_Del_Cuenta_Corriente(string @cCodEmp, string @cTipAna, string @cCodigo, out string @cMsgRetorno);
        #endregion
