...
namespace Inv.DataAccess
{
    public abstract class DocumentoAccesor : AccessorBase<DocumentoAccesor>
    {
        ...
        public abstract void InsertarDocumento(string @cCodEmp, string @cAnno, string @cMes, string @cTipoDocu, string @cDocumento, string @dFechaDoc,
                                            ...
                                            string @in06prodActiNivel1Cod, out string @cDocuNumer, out string @cMsgRetorno);
        ...
        public abstract void EliminarDetalle(string @cCodEmp, string @cAnno, string @cMes, string @cTipDoc, string @cNumDoc, string @cTranMov, string @dFechaDoc,
        ...
        public abstract void Spu_Pro_Upd_CambiarDeAlmacen(string @IN07CODEMP,string @IN07AA,string @IN07MM,string @IN07TIPDOC,string @IN07CODDOC,string @IN07ORDENTRABAJO,
        ...
        string @IN07ORDENTRABAJO, string @IN07CODALM, string @IN07NROCAJA, string @Almacenuevo, 
        string @IN07NROCAJANEW, string @IN07KEYNEW, string @FlagCampoaActualizar, 
        out int @flagReturn, out string @cMsgRetorno);
        ...
        public abstract DataTable Spu_Inv_Rep_StockMP(string @empresa, string @periodo, string @almacen, string @XMLrango);
        ...
        string @FAC04FETIPONOTA,  out int @flag, out string @msgretorno);
        ...
        string @FAC04TIENDA, double @FAC04DESCUENTOGLOBAL, string @FAC04FETIPONOTA,out int @flag, out string @msgretorno);
        ...
        string @FAC05FEPRODUCTOTIPO, string @FAC05FEIMPORTEREFERENCIAL, string @FAC05FEIMPORTECARGO,out int @flag, out string @msgretorno);
        ...
        string @FAC05FEIMPORTEREFERENCIAL, string @FAC05FEIMPORTECARGO, 
