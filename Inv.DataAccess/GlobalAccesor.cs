...
namespace Inv.DataAccess
{
    public abstract class GlobalAccesor : AccessorBase<GlobalAccesor>
    {
        ...
        public abstract List<Moneda> Spu_Glo_Trae_glo01tablas_Det(string @glo01codigotabla, string @cCampo, string @cFiltro);
        ...
        /********************************** Ayuda web touch ****************************************************/
        [SprocName("Spu_Glo_Trae_AyudaTouch")]
        public abstract List<TablaGlobal> Spu_Glo_Trae_AyudaTouch(string @CodigoEmpresa, string @FlagTipoAyuda, string @ParametroFiltroAyuda);
    }
}
