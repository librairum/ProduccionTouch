...
namespace Inv.DataAccess
{
    public abstract class SegUsuarioAccesor : AccessorBase<SegUsuarioAccesor>
    {
        ...
        public abstract void Spu_Seg_Actualizar_Usuario(string @Codigo,
 ...
 out string @msj);
        ...
        public abstract void Spu_Seg_Eliminar_Usuario(string
 @NombreUsuario,
 string @ClaveUsuario,
 string @CodigoPerfil,
 string @CodigoEmpresa,
 out string @msj);
        ...
        public abstract void Spu_Seg_Actualizar_Clave(string @Codigo,
string @ClaveUsuario,
string @CodigoPerfil,
string @CodigoEmpresa,
out string @msj);
