  ...
  public abstract  class SubPlantillaAccesor : AccessorBase<SubPlantillaAccesor>
    {
      ...
      public abstract void InsertarSubPlantilla(string @FAC03CODEMP,  string @FAC03COD,  string @FAC01COD,  
       ...
       string @FAC03SERIEXDEF,  string @FAC03TIPART,  out string @msgretorno) ;
      ...
      public abstract void ActualizarSubPlantilla( string @FAC03CODEMP, string @FAC03COD, 
          ...
          string @FAC03TIPART, out string @msgretorno);
      
      
      [SprocName("Spu_Fact_DEL_FAC03_SUBPLANTILLA")]
      public abstract void EliminarSubPlantilla(string @FAC03CODEMP, string @FAC03COD, string @FAC01COD, out string @msgretorno);
      ...
      public abstract List<Moneda> TraeAyudaProductos(string @glo01codigotabla, string @cCampo, string @cFiltro);
